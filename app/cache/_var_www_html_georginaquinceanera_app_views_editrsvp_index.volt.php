             ...
             <div class="div-table-row"> 
             	<div class="div-table-col2">
				          ...
				          <div class="div-table-cell">Email Address</div>
				          	...
				          	<div class="div-table-col1">  
				          <div class="div-table-cell"><input name="email" value="<?php echo $post->email; ?>" /></div>
				          </div>
				          </div>
				          ...
				          <div class="div-table-cell">Contact Number</div>
				            ...
				            <div class="div-table-col1"> 
				          <div class="div-table-cell"><input name="phone_number" value="<?php echo $post->phone_number; ?>" /></div>
				          </div>
				          </div>
